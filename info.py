...
BOT_TOKEN = environ.get('BOT_TOKEN', '6714823493:AAFSwyzt40rGkfHjvrRG3YqXEueMMMJJ_RE')
# Bot settings
...
INDEX_REQ_CHANNEL = int(environ.get('INDEX_REQ_CHANNEL', -1002039420546))
...
FILE_REQ_CHANNEL = int(environ.get('FILE_REQ_CHANNEL',-1002009540249))
